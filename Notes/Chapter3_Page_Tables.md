...
- [Chapter 3 Page Tables](#chapter-3-page-tables)
  * [Paging Hardware](#paging-hardware)
    + [I. PTE](#i-pte)
    + [II. Three level structure](#ii-three-level-structure)
    + [III. Physical Address and Virtual address](#iii-physical-address-and-virtual-address)
  * [Kernel Address Space](#kernel-address-space)
    + [I. Layout](#i-layout)
    + [II. Direct Mapping](#ii-direct-mapping)
    + [III. Mapping](#iii-mapping)
  * [Creating an address space](#creating-an-address-space)
    + [I. data structures and functions](#i-data-structures-and-functions)
    + [II. setup procedures](#ii-setup-procedures)
    + [III. `kvminithart`](#iii--kvminithart-)
    + [IV. `procinit`](#iv--procinit-)
    + [V. `Translation Look-aside Buffer (TLB)`](#v--translation-look-aside-buffer--tlb--)
  * [Physical memory allocation](#physical-memory-allocation)
  * [Code: Physical Memory Allocator](#code--physical-memory-allocator)
    + [I. free list](#i-free-list)
    + [II. `kinit`](#ii--kinit-)
    + [III. types - int and pointer](#iii-types---int-and-pointer)
    + [IV. `kfree`](#iv--kfree-)
  * [Process address Space](#process-address-space)
    + [I. range](#i-range)
    + [II. grow memory](#ii-grow-memory)
    + [III. examples of use of page tables.](#iii-examples-of-use-of-page-tables)
    + [IV. user stack](#iv-user-stack)
  * [Code: sbrk](#code--sbrk)
    + [I. implementation](#i-implementation)
    + [II. usage of process's page table](#ii-usage-of-process-s-page-table)
  * [exec](#exec)
    + [I. overview](#i-overview)
    + [II. Procedures](#ii-procedures)
    + [III. exception](#iii-exception)
    + [IV. security checks for ELF](#iv-security-checks-for-elf)
  * [Real World](#real-world)
    + [I. paging](#i-paging)
    + [II. direct mapping](#ii-direct-mapping)
    + [III. protection](#iii-protection)
    + [IV. super pages.](#iv-super-pages)
## Paging Hardware
### I. PTE
